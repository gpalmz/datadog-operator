...
func (builder *DatadogAgentInternalBuilder) WithAdmissionControllerProbeNamespace(ns string) *DatadogAgentInternalBuilder {
	builder.initAdmissionController()
	builder.datadogAgentInternal.Spec.Features.AdmissionController.Probe.Namespace = apiutils.NewStringPointer(ns)
	return builder
}
...
func (builder *DatadogAgentInternalBuilder) WithUseFIPSAgent() *DatadogAgentInternalBuilder {
	...
	builder.datadogAgentInternal.Spec.Global.UseFIPSAgent = apiutils.NewBoolPointer(true)
	return builder
}
