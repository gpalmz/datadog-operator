...
func (builder *DatadogAgentBuilder) WithAdmissionControllerProbeNamespace(ns string) *DatadogAgentBuilder {
	builder.initAdmissionController()
	builder.datadogAgent.Spec.Features.AdmissionController.Probe.Namespace = apiutils.NewStringPointer(ns)
	return builder
}
